...
public class ApiConfig {
    private String[] domains = new String[]{"http://app.leke-dev.com/", "http://app.leke-dev.com/", "http://app.leke-test.com/", "http://app.leke-dev.com/", "http://yapi.youximao.cn/mock/29/"};//域名
    private String[] webDomains = new String[]{"http://web.leke-dev.com/", "http://web.leke-dev.com/", "http://web.leke-test.com/", "http://web.leke-dev.com/", "http://web.leke-dev.com/"};//h5主域名
