package com.yufan.library.view.banner;
...
import com.yufan.library.view.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int indicatorSize;  //圆点大小
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected,R.drawable.white_radius);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected,  R.drawable.gray_radius);
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        viewPager = (BannerViewPager) view.findViewById(R.id.b_viewpager);
        ...
        initViewPagerScroll();
        ((RelativeLayout.LayoutParams)indicator.getLayoutParams()).bottomMargin=mIndicatorMarginBottom;
    }
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            ...
            if (imageLoader != null)
                imageLoader.displayImage(toRealPosition(i),context, url, imageView);
            else
