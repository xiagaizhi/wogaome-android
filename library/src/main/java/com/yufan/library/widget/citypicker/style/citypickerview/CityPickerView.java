package com.yufan.library.widget.citypicker.style.citypickerview;
...
import com.yufan.library.widget.citypicker.citywheel.CityParseHelper;
import com.yufan.library.widget.citypicker.style.citypickerview.widget.CanShow;
import com.yufan.library.widget.citypicker.style.citypickerview.widget.wheel.OnWheelChangedListener;
import com.yufan.library.widget.citypicker.style.citypickerview.widget.wheel.WheelView;
import com.yufan.library.widget.citypicker.style.citypickerview.widget.wheel.adapters.ArrayWheelAdapter;
import com.yufan.library.widget.citypicker.utils.Utils;
...
public class CityPickerView implements CanShow, OnWheelChangedListener {
    ...
    private void initCityPickerPopwindow() {
        ...
        popwindow.setAnimationStyle(R.style.AnimBottomDialog);
